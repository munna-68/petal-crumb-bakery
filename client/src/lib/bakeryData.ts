...
export const galleryItems: GalleryItem[] = [
  { id: 1, title: "Garden tier", category: "Weddings", image: withBase("/images/photo-1578985545062-69928b1d9587.jpg"), alt: "Flower-topped celebration cake" },
  { id: 2, title: "Pistachio cloud", category: "Little Cakes", image: withBase("/images/photo-1602351447937-745cb720612f.jpg"), alt: "Small frosted cake" },
  { id: 3, title: "Birthday blush", category: "Birthdays", image: withBase("/images/photo-1559620192-032c4bc4674e.jpg"), alt: "Pink birthday cake" },
  { id: 4, title: "Lemon garden", category: "Birthdays", image: withBase("/images/photo-1535254973040-607b474cb50d.jpg"), alt: "Decorated lemon cake" },
  { id: 5, title: "Wildflower vows", category: "Weddings", image: withBase("/images/photo-1578985545062-69928b1d9587.jpg"), alt: "Wedding cake with flowers" },
  { id: 6, title: "Butter shortbread", category: "Cookies", image: withBase("/images/photo-1499636136210-6f4ee915583e.jpg"), alt: "Fresh baked cookies" },
];
...
export const menuItems = [
  ...
  { title: "Cupcake dozen", detail: "Twelve floral-topped cupcakes in two complementary seasonal flavors.", price: "from $42", image: withBase("/images/photo-1551024506-0bccd828d307.jpg"), tag: "Seasonal" },
